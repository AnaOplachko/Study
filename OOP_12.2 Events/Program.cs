namespace OOP_12._2_Events
{
    ...
    class Program
    {
        ...
        static private void Handler()
        {
            ...
            Console.ForegroundColor = (ConsoleColor)randomColor.Next(15);
            Console.WriteLine("НУ ВОТ И ЕЩЕ ОДНА ТАЧКА В НАШЕМ ПАРКЕ. ЖЕНА УБЬЕТ!!!!!");
        ...
        static void Main()
        {
            ...
            do
            {
                ...
                if (decision == "yes" && decision != null) // не понятно краш от не введенного числа
                    repeat = true;
